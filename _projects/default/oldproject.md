...
<div class="p-4">
    <h2>Old project</h2>
    <hr />
  <img data-src="{{ 'assets/images/photos/cover1.jpg' | relative_url }}" class="lazy rounded-top" style="width: 30%; height: auto;" src="{{ '/assets/images/empty_300x200.png' | relative_url }}">
  <img data-src="{{ 'assets/images/photos/cover1.jpg' | relative_url }}" class="lazy rounded-top" style="width: 30%; height: auto;" src="{{ '/assets/images/empty_300x200.png' | relative_url }}">
 <img data-src="{{ 'assets/images/photos/cover1.jpg' | relative_url }}" class="lazy rounded-top" style="width: 30%; height: auto;" src="{{ '/assets/images/empty_300x200.png' | relative_url }}">
