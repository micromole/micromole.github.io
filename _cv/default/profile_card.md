...
<div>
     <div style="text-align: right;">
       <img data-src="{{ 'assets/images/photos/AW_logo.jpg' | relative_url }}" alt="Arne Weinhold" class="lazy frame-img rounded-lg" 
           src="{{ '/assets/images/empty_300x200.png' | relative_url }}" data-toggle="tooltip" data-placement="top" title="Arne Weinhold" style="float: left; max-height: 295px; margin-right: 10px;">
           </div>
  <div class="card-body">
