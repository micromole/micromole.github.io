...
<div class="p-4">
     <div style="text-align: right;">
       <img data-src="{{ 'assets/images/photos/AW_logo.jpg' | relative_url }}" alt="Arne Weinhold" class="lazy frame-img rounded-lg" 
           src="{{ '/assets/images/empty_300x200.png' | relative_url }}" data-toggle="tooltip" data-placement="top" title="Arne Weinhold" style="max-height: 295px; object-fit: cover; margin-right: 10px;">
           </div>
     <div class="card-body">
