...
<div>
     <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 1px;">
       <img data-src="{{ 'assets/images/photos/AW_logo.jpg' | relative_url }}" alt="Arne Weinhold" class="lazy w-100 rounded-lg" 
           src="{{ '/assets/images/empty_300x200.png' | relative_url }}" data-toggle="tooltip" data-placement="top" title="Arne Weinhold" style="max-height: 295px; max-width: 400px; width: 100%; object-fit: cover;">
     </div>
  <div class="card-body">
